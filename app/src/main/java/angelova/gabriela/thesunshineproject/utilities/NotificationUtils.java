package angelova.gabriela.thesunshineproject.utilities;
...
import angelova.gabriela.thesunshineproject.DetailActivity;
import angelova.gabriela.thesunshineproject.R;
...
public class NotificationUtils {
    ...
    public static final int NOTIFICATIONS_ID = 3021;
...
//          Notify the user with the ID WEATHER_NOTIFICATION_ID
            notificationManager.notify(NOTIFICATIONS_ID, notificationBuilder.build());
