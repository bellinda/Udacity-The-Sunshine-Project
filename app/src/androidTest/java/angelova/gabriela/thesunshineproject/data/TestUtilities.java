...
import angelova.gabriela.thesunshineproject.utils.PollingCheck;

import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_DATE;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_DEGREES;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_HUMIDITY;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_MAX_TEMP;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_MIN_TEMP;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_PRESSURE;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_WEATHER_ID;
import static angelova.gabriela.thesunshineproject.data.WeatherContract.WeatherEntry.COLUMN_WIND_SPEED;
